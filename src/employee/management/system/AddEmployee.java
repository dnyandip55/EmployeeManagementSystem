...
public class AddEmployee  extends JFrame implements ActionListener{
    ...
    AddEmployee(){
        ...
        heading.setFont(new Font("SAN_SERIF",Font.PLAIN,20));
        add(heading);
     ...
     labeledu.setBounds(400,300,150,30);
      labeledu.setFont(new Font("SAN_SERIF",Font.PLAIN,20));
       ...
       String courses[] ={ " ","BBA" ,"BCA" ,"BA","BCOM","BSC" ,"BCS" ,"BTech","MSC","MCS","MCA","MTech","MBA","PHD"};
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==add){
            ...
            try{
                Conn conn=new Conn();
                String query="insert into employee values('"+name+"','"+fname+"','"+dob+"','"+salary+"','"+address+"','"+phone+"','"+email+"','"+edu+"','"+designation+"','"+adhar+"','"+empId+"')";
